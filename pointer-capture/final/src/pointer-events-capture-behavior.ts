...
const onPointerMove = (evt: PointerEvent) => {
    ...
    const pickResult = _scene.pick(pointerScreenX, pointerScreenY, (mesh) => {
        ...
        //pointerCaptureBehavior = meshToBehaviorMap.get(mesh);
        // const attachedMeshId = pointerCaptureBehavior?.attachedMesh?.id;
        // console.log("In scene.pick predicate - pointerCaptureBehavior, attached mesh id = ", pointerCaptureBehavior, attachedMeshId);
