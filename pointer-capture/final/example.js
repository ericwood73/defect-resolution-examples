...
const createScene = () => {
    ...
    const htmlMeshDiv2 = new HtmlMesh(scene, "html-mesh-div");
    ...
    htmlMeshDiv2.setContent(div2, 4, 3);
    htmlMeshDiv2.position.x = -3;
    htmlMeshDiv2.position.y = 4;
    htmlMeshDiv2.position.z = 1;
    htmlMeshDiv2.rotation = new Vector3(Math.PI / 4, Math.PI / 4, Math.PI / 4);
