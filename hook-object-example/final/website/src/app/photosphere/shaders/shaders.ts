...
export default class Shaders {
    ...
    static motionBlurFragmentShader = `
    varying vec2 vUv;
    ...
    static motionBlurShader = {
        ...
        vertexShader: this.motionBlurVertexShader,
        fragmentShader: this.motionBlurFragmentShader
    }
}